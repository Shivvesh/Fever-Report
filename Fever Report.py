...
Question1 = Label(root, text = "Do you have a headache and sore throat")
Question1.pack()
...
Question2 = Label(root, text = "Do you have a headache and sore throat")
Question2.pack()
...
Question3 = Label(root, text = "Do you have a headache and sore throat")
Question3.pack()
...
def fever_score():
    ...
    if score <= 20:
        ...
        messagebox.showinfo("Report", "I strongly advise you to please visit a doctor")
        
        
btn = Button(root, text = "Click Me to View Your Results", command = fever_score)
btn.pack()    
root.mainloop()